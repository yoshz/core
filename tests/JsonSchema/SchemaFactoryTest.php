    ...
    public function testBuildSchemaForAssociativeArray(): void
    {
        ...
        $typeFactoryProphecy->getType(Argument::allOf(
            ...
            Argument::that(function(Type $type) {
                ...
                return count($keyTypes) === 1 && $keyTypes[0] instanceof Type && $keyTypes[0]->getBuiltinType() === Type::BUILTIN_TYPE_INT;
            })
        ), Argument::cetera())->willReturn([
            'type' => 'array',
        ]);
        $typeFactoryProphecy->getType(Argument::allOf(
            ...
            Argument::that(function(Type $type) {
                $keyTypes = $type->getCollectionKeyTypes();
                return count($keyTypes) === 1 && $keyTypes[0] instanceof Type && $keyTypes[0]->getBuiltinType() === Type::BUILTIN_TYPE_STRING;
            })
        ), Argument::cetera())->willReturn([
            'type' => 'object',
